...
<body>
	...
	<center>
		...
		if (!rs.next()) {
			...
			rs = st.executeQuery(
			"select * from student,marks where student.roll_no='" + rollno + "' and student.roll_no=marks.rollno");
			rs.next();
		}
		%>
				...
				<table border="1px" style="width: 100%;">
					<thead>
						<tr>
							<th>
								<%
								if (rs.getString("Course").equals("MCA"))
									out.print("Data Stucture");
								else if (rs.getString("Course").equals("BCA"))
									out.print("C++");
								else if (rs.getString("Course").equals("B.Tech"))
									out.print("Python");
								else if (rs.getString("Course").equals("M.Tech"))
									out.print("Math");
								%>
							</th>
						...
						<tr>
							<th>
								<%
								if (rs.getString("Course").equals("M.Tech"))
									out.print("Data Stucture");
								else if (rs.getString("Course").equals("B.Tech"))
									out.print("Android");
								else if (rs.getString("Course").equals("BCA"))
									out.print("Python");
								else if (rs.getString("Course").equals("MCA"))
									out.print("Math");
								%>
							</th>
							...
							<th>
								<%
								if (rs.getString("Course").equals("B.Tech"))
									out.print("Data Stucture");
								else if (rs.getString("Course").equals("M.Tech"))
									out.print("Android");
								else if (rs.getString("Course").equals("MCA"))
						...
						<tr>
							<th>Total</th>
							<td><%=Integer.parseInt(rs.getString("m1")) + Integer.parseInt(rs.getString("m2"))
		+ Integer.parseInt(rs.getString("m3")) + Integer.parseInt(rs.getString("m4"))
		+ Integer.parseInt(rs.getString("m5"))%></td>
							<th>Percentage</th>
							<td>
								<%
								int per = (Integer.parseInt(rs.getString("m1")) + Integer.parseInt(rs.getString("m2"))
										+ Integer.parseInt(rs.getString("m3")) + Integer.parseInt(rs.getString("m4"))
										+ Integer.parseInt(rs.getString("m5"))) / 5;
								out.print(per + " %");
								%>
							</td>
						</tr>

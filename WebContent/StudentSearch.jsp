...
<form action="StudentSearch.jsp" method="post">
<input  class="c" type="text" name="Roll_no" placeholder="Roll no" value="<%=rs.getString("Roll_no")%>">
<input  class="c" type="text" name="Name" placeholder="Name" value="<%=rs.getString("Name")%>">
<input  class="c" type="text" name="Course" placeholder="Course" value="<%=rs.getString("Course")%>">
<input  class="c" type="text" name="Branch" placeholder="Branch" value="<%=rs.getString("Branch")%>">
<input  class="c" type="text" name="Gender" placeholder="Gender" value="<%=rs.getString("Gender")%>">
<input  class="c" type="text" name="Password" placeholder="Password" value="<%=rs.getString("Password")%>">
...
<form>
<input  class="c" type="hidden" name="Roll_no" placeholder="Roll_no" value="<%=rs.getString("Roll_no")%>">
...
if(request.getParameter("update")!=null)
{
	...
	try{
		...
		int i=stm.executeUpdate("update student set Name='"+Name+"',Course='"+Course+"',Branch='"+Branch+"',Gender='"+Gender+"',Password='"+Password+"' where Roll_no='"+Roll_no+"'");

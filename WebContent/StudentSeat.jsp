...
{
%>
<a href=seat.jsp?rollno=<%=rs.getString("Roll_no")%>>Seat Allocation</a>
 <%} %>         
</td>
<td>

<a href=seatupdate.jsp?rollno=<%=rs.getString("Roll_no")%>>Seat Update</a>
                                              ...
                                              String Password=request.getParameter("Password");
                                            	  ...
                                            	  else   if(request.getParameter("update")!=null)
                                            	  {
                                              	  	...
                                              	  	try{
                                              	  		...
                                              	  		int i=stm.executeUpdate("update from student set Roll_no='"+Roll_no+"',name='"+Name+"',Course='"+Course+"',Branch='"+Branch+"',Gender='"+Gender+"' WHERE  Roll_no='"+Roll_no+"'");
                                              	  		if(i>0)
                                              	  		{
                                              	  			out.print("Deleted");
                                              	  		}
